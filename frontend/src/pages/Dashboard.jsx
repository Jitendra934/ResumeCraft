      ...
      <div className="max-w-7xl mx-auto px-4 py-8 ">
        ...
        <div className="flex gap-4">
          <button
            ...
            className="w-full bg-linear-to-br from-indigo-100 to-purple-100  sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-800 border border-dashed border-slate-300 group hover:border-indigo-500 hover:shadow-lg transition-all duration-300 cursor-pointer"
          >
          ...
          <button
            ...
            className="w-full bg-linear-to-bl from-indigo-100 to-purple-100 sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-purple-500 hover:shadow-lg transition-all duration-300 cursor-pointer"
          >
